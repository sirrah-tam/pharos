...
<PageSection title="Productive Motion">
  ...
  >
    <strong>Productive motion</strong> is focused and uncomplicated. Use productive motion to help users achieve their goals and perform tasks efficiently.
  </div>
  <PharosHeading level="3" preset="4">
    Guiding the user's attention
  </PharosHeading>
  <p style={{ color: 'var(--pharos-color-text-20)' }}>
    Focus the user's attention to important elements on the page, such as a button or form fields that require input. Employ bold motion design to convey a warning or prevent errors, or when highlighting the most crucial information on the page. Bold motion design elements should be used sparingly or in combination with more subtle elements to achieve a well-balanced and effective motion design.
  </p>
  ...
  <p style={{ color: 'var(--pharos-color-text-20)' }}>
     When users take an action, provide feedback to let them know that the action has been registered and is being processed. 
  </p>
  <Grid columns={2}>
...
<PageSection title="Expressive Motion">
  ...
  >
    <strong>Expressive motion</strong> employs visual and kinetic elements to create dynamic and vibrant experiences. It achieves this by facilitating smooth transitions between pages and states, leading the user seamlessly throughout the entire journey.
  </div>
  <PharosHeading level="3" preset="4">
    Emphasize
  </PharosHeading>
  <p style={{ color: 'var(--pharos-color-text-20)' }}>
    Capture the user's attention by employing motion that highlights the position of elements on the screen. For example, you can achieve this effect by smoothly sliding a sidebar into view or by visually indicating a change in the state of an element.
  </p>
  <Grid columns={2} bottom={2}>
  ...
  <p style={{ color: 'var(--pharos-color-text-20)' }}>
    Aim to create smooth and fluid transitions that simplify the user experience without being overwhelming. It should have a clear visual hierarchy with predictable and logical element movement. Transitions are used to smoothly move elements from one state to another, such as when a user navigates from one page to another or when a menu expands or collapses. Transitions help to create a sense of continuity and cohesion in the interface.
  </p>
  <Grid columns={2} bottom={2}>
    <FontDisplay font="GT America Standard" title="GT America regular" dark />
    <FontDisplay font="GT America Standard" title="GT America medium" dark bold />
  ...
  <p style={{ color: 'var(--pharos-color-text-20)' }}>
    Capture the user's interest and motivate them to explore the site further. Inspire the user to ask questions and make new discoveries. This type of motion design can be an effective tool for building a strong and lasting relationship with the user, fostering a sense of engagement and encouraging them to return for more.
  <Grid columns={2} bottom={2}>
    <FontDisplay font="GT America Standard" title="GT America regular" dark />
    <FontDisplay font="GT America Standard" title="GT America medium" dark bold />
  </Grid>
</PageSection>
<!-- Need a link to the tokens page when created here -->
<!-- <a href="tokens">Easing and Duration Tokens</a> -->
<!-- I do not need anything from here down -->
